...
-- ============================================
-- 10. Tablas para persistencia de instrumentos RF-010
-- ============================================

CREATE TABLE IF NOT EXISTS valoracion_instrumento (
    ID_VALORACION_INSTRUMENTO INT AUTO_INCREMENT PRIMARY KEY,
    CARACTERIZACION_ID INT NULL,
    DIMENSION VARCHAR(50) NOT NULL,
    ESTUDIANTE_IDENTIFICACION VARCHAR(100) NULL,
    FECHA_VALORACION TIMESTAMP NULL,
    PUNTUACION_TOTAL INT NULL,
    OBSERVACIONES TEXT NULL,
    RECOMENDACIONES TEXT NULL,
    CREATED_AT TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    UPDATED_AT TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    CONSTRAINT fk_valoracion_caracterizacion FOREIGN KEY (CARACTERIZACION_ID) REFERENCES caracterizacion(ID_CARACTERIZACION) ON DELETE SET NULL ON UPDATE CASCADE,
    INDEX idx_valoracion_dim (DIMENSION),
    INDEX idx_valoracion_estudiante (ESTUDIANTE_IDENTIFICACION)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

CREATE TABLE IF NOT EXISTS valoracion_respuesta (
    ID_RESPUESTA INT AUTO_INCREMENT PRIMARY KEY,
    ID_VALORACION_INSTRUMENTO INT NOT NULL,
    PREGUNTA_KEY VARCHAR(100) NOT NULL,
    VALOR INT NOT NULL,
    COMENTARIO TEXT NULL,
    CREATED_AT TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_respuesta_valoracion FOREIGN KEY (ID_VALORACION_INSTRUMENTO) REFERENCES valoracion_instrumento(ID_VALORACION_INSTRUMENTO) ON DELETE CASCADE ON UPDATE CASCADE,
    INDEX idx_respuesta_valoracion (ID_VALORACION_INSTRUMENTO),
    INDEX idx_respuesta_pregunta (PREGUNTA_KEY)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
