...
--
-- Servidor: localhost
-- Tiempo de generación: 02-12-2025 a las 05:56:31
...
INSERT INTO `caracterizacion` (`ID_CARACTERIZACION`, `CODIGO_CARACTERIZACION`, `ESTUDIANTE_ID_ESTUDIANTE`, `CONTEXTO_ACADEMICO`, `CONTEXTO_FAMILIAR`, `CONTEXTO_ESCOLAR`, `DIAGNOSTICO`, `VALORACION_PEDAGOGICA`, `BARRA_DE_APRENDIZAJE`, `RECOMENDACIONES`, `CORRESPONSABILIDAD`) VALUES
(2, '20251145328856', 1, 'BAJO NIVEL', 'APOYO FAMILIAR', 'DIFICULTAD LECTURA', 'DISLEXIA', 'REALIZAR PIAR', 'CONTEXTUAL Y SOCIAL', 'APOYO VISUALES', 'OPORTUNA');
...
--
ALTER TABLE `caracterizacion`
  MODIFY `ID_CARACTERIZACION` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
