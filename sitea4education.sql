...
INSERT INTO `usuarios` (`ID_USUARIO`, `NUMERO_DOCUMENTO`, `PRIMER_NOMBRE`, `PRIMER_APELLIDO`, `TELEFONO_USUARIO`, `DIRECCION_USUARIO`, `CORREO_USUARIO`, `CORREO_INSTITUCIONAL`, `PASSWORD`, `ESTATUS`, `TIPO_DOCUMENTO_ID_TIPO_DOCUMENTO`, `FECHA_REGISTRO_ID_FECHA_REGISTRO`, `FOTO_PERFIL`) VALUES
(1, '1052395145', 'BRANDON JAHIR', 'CABRA BULLA', NULL, '', NULL, NULL, '$2a$10$WWnsreg/QmyulhPNMnV2eOl6FLt/kRU8Mvwj/SPg.p9YySv7dDc.m', 'ACTIVO', 1, NULL, 'resources/images/perfiles/profesor_default.jpg'),
(3, '12345678911', 'SAMUEL', 'LOPEZ', NULL, '', NULL, NULL, '$2y$10$ACqTrIb/6QJLk.D5rwVpLegsmZcUF2YAEc5.m.PgDodmJRzm7J14m', 'ACTIVO', 1, NULL, NULL),
(4, '1052395144', 'Raul', 'Garcia', NULL, '', NULL, NULL, '$2a$10$n9j7.R8wDjO6KzXo5HuDD.34bQ7hKOQT/Lltp6hcKiueqc8nlFome', 'ACTIVO', 1, NULL, NULL),
(5, '1052395146', 'ANDREA', 'GARCIA', NULL, '', NULL, NULL, '$2a$10$QdAw/574FrIaJET.x34Kze/h2o7JZ4o3lZSWnyUEucW7xa4MV.x8C', 'ACTIVO', 1, NULL, NULL),
(6, '1032460451', 'FREDDY', 'CASTRO', NULL, '', NULL, NULL, '$2a$10$fmrpRVqJTJnx1mDC5kimk.xFZBMD2l59lcE6sS0Cq4XbtJsWsjntO', 'ACTIVO', 1, NULL, 'resources/images/perfiles/admin_default.png'),
(7, '1018477769', 'SEBASTIAN', 'MORENO', NULL, '', NULL, NULL, '$2a$10$/2.dYR3GP4HcG75vQdZVcu/yRMSlz9VmuKaECuAjTKmMmAw2Zq36O', 'ACTIVO', 1, NULL, NULL),
...
ALTER TABLE `usuario_rol`
  ...
  ADD UNIQUE KEY `uq_usuario_rol` (`USUARIO_ID_USUARIO`,`ROL_ID_ROL`),
